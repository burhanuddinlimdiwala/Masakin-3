...
(function() {
  ...
  document.getElementById('hotspot2').addEventListener('click', function() {
    ...
    var scene = findSceneById("6-passage-2");  // Replace with your scene ID
    switchScene(scene);
  });
  
  document.getElementById('hotspot3').addEventListener('click', function() {
  
    var scene = findSceneById("5-passage");  // Replace with your scene ID
    switchScene(scene);
  });
  document.getElementById('hotspot4').addEventListener('click', function() {
  
    var scene = findSceneById("7-kitchen");  // Replace with your scene ID
    switchScene(scene);
  });

  document.getElementById('hotspot5').addEventListener('click', function() {
  
    var scene = findSceneById("4-bed-room-3");  // Replace with your scene ID
    switchScene(scene);
  });
  document.getElementById('hotspot6').addEventListener('click', function() {
  
    var scene = findSceneById("2-bed-room-2-v1");  // Replace with your scene ID
    switchScene(scene);
  });

  document.getElementById('hotspot7').addEventListener('click', function() {
  
    var scene = findSceneById("3-bed-room-2-v2");  // Replace with your scene ID
    switchScene(scene);
  });
  document.getElementById('hotspot8').addEventListener('click', function() {
  
    var scene = findSceneById("1-bed-room-1");  // Replace with your scene ID
    switchScene(scene);
  });
